...
void next_anim() {
  ...
  switch (anim_count) {
    case 0:
      effect_layer_add_effect(h1, effect_invert, NULL);
      break;
    case 1:
      effect_layer_remove_effect(h1);
      effect_layer_add_effect(h1, effect_rotate_90_degrees, (void *)true);
      break;
    case 2:
      effect_layer_remove_effect(h1);
      effect_layer_add_effect(h1, effect_mirror_vertical, NULL);
      break;
    case 3:
      effect_layer_remove_effect(h1);
      break;
...
//   effect_layer_add_effect(effect_layer, effect_mask, &mask);
  ...
  // effect_layer_add_effect(h1, effect_blur, (void*)3);
  effect_layer_add_effect(h1, effect_rotate_90_degrees, (void *)true);
